...
2. Visit the website [PromptAppGPT Web Home](http://promptappgpt.wangzhishi.net) 
   Or download the [Windows 10+ APP](https://github.com/Significant-Gravitas/Auto-GPT/releases/latest).
